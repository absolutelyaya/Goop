...
public class LandingEmitter extends AbstractEmitter
{
	...
	public LandingEmitter(List<EntityTypeReference> targets, BaseGoopData goopData)
	{
	...
	{
		HitResult hit = entity.getWorld().raycast(new RaycastContext(entity.getPos(), entity.getPos().add(0, -1, 0), RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.NONE, entity));
		Vec3d hitPos = hit.getPos();
		entity.getWorld().addParticleClient(new PuddleParticleEffect(goopData, Direction.UP),
